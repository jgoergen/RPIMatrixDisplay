...
class Integration(object):
    ...
    def runParticleCollisions(self):
        ...
        for i in range(0, len(self.particles)):
            if (self.particles[i].collides is not True or self.particles[i].radius == 0):
                continue

            for o in range(0, len(self.particles)):
                if (self.particles[o].collides is not True or self.particles[o].radius == 0 or i == o):
                    continue
    ...
    def runParticleOnLineCollisions(self):
        ...
        for i in range(0, len(self.particles)):
            if (self.particles[i].collides is not True):
                continue
